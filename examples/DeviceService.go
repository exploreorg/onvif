...
import (
	...
	goonvif "github.com/exploreorg/onvif"
	"github.com/exploreorg/onvif/device"
	sdk "github.com/exploreorg/onvif/sdk/device"
	"github.com/exploreorg/onvif/xsd/onvif"
)
...
func main() {
	...
	if err != nil {
		...
		// You could use https://github.com/exploreorg/onvif/gosoap for pretty printing response
